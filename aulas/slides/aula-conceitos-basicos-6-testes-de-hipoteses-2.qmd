...
- Teste t para duas amostras independentes
  - Variâncias são iguais
    - Temos $s_1^2$ e $s_2^2$
    - Calculamos a variância ponderada
$$
 s^2=  \frac{(𝑛_1−1)𝑠_1^2+(𝑛_2−1)𝑠_2^2}{(𝑛_1+ 𝑛_2  −2)}
$$
...
Se o valor absoluto de $t \ge t_{tab}$: médias são diferentes
